...
import java.util.*;
/**
 * The {@code Main} class serves as the entry point for the CLI
 * version of the NHL Stat Tracker application.
 * <p>
 * It allows users to interact with player statistics through a text-based menu system.
 * Users can add, remove, update, view, filter, and search players stored in an SQLite database.
 * </p>
 */
public class Main {
    /**
     * The main method that initializes the database connection and launches the CLI menu loop.
     *
...
//Database handler replaces file handler from previous phases
    ...
    /**
     * Handles user input for adding a new player to the database.
     * <p>
     * Validates input to ensure names are not numeric and that stats are integers.
     * Displays a confirmation or error message based on the outcome.
     * </p>
     *
     * @param manager the {@link StatManager} used to handle player operations
    ...
    /**
     * Handles user input for removing a player by name.
     * Displays confirmation or error messages depending on the result.
     *
     * @param manager the {@link StatManager} used for player operations
     * @param scanner the {@link Scanner} used for user input
     */
    ...
    /**
     * Handles user input for updating a player’s statistics.
     * Prompts for new team name, goals, assists, and plus/minus values.
     *
     * @param manager the {@link StatManager} used for player operations
     * @param scanner the {@link Scanner} used for user input
     */
    //Updating a player will allow the user to change the team name, goals,assists, and plus/minus of a player
    ...
    /**
     * Displays all players currently stored in the database.
     *
     * @param manager the {@link StatManager} used to retrieve player data
     */
    ...
    /**
     * Allows the user to filter players based on goals, assists, points, or team.
     * Displays the filtered results.
     *
     * @param manager the {@link StatManager} used for filtering player data
     * @param scanner the {@link Scanner} used for user input
     */
    ...
    /**
     * Searches for a player by name and displays their statistics if found.
     *
     * @param manager the {@link StatManager} used for searching player data
     * @param scanner the {@link Scanner} used for user input
     */
